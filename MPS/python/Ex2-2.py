...
def parse_args():
    parser = argparse.ArgumentParser(description='siumulator for MPS decomposition of the GS of one dimensional spin model')
    ...
    parser.add_argument('-chi', metavar='chi_max',dest='chi_max', type=int, default=10,
                        help='maximum bond dimension at truncation  (default = 10)')
